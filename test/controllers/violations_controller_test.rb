...
class ViolationsControllerTest < ActionController::TestCase
  ...
  test "should create violation" do
    assert_difference('Violation.count') do
      post :create, violation: { date: @violation.date, picture: @violation.picture, plateNum: @violation.plateNum, plateState: @violation.plateState, violationType: @violation.violationType }
    end
  ...
  test "should update violation" do
    patch :update, id: @violation, violation: { date: @violation.date, picture: @violation.picture, plateNum: @violation.plateNum, plateState: @violation.plateState, violationType: @violation.violationType }
    assert_redirected_to violation_path(assigns(:violation))
  end
